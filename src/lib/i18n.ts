...
const ja = {
  ...
  errorHonkokuUnavailable: "Honkoku v18が無効、またはモデルManifestが未設定です。",
  errorGeneric: "処理に失敗しました。",
  serviceNoticeTitle: "ご利用前に",
  serviceNoticeBodyJa: "このOCRは国立国会図書館(NDL)が作成した古典籍OCR-LiteおよびCODHのMetomくずし字認識サービスを用いた簡易OCRサービスです。CC BY 4.0で提供されているサービスを元に作られているサービスであることをご了承ください。",
  serviceNoticeBodyEn: "This is a simple OCR service that uses Koten OCR-Lite, developed by the National Diet Library (NDL), and CODH's Metom kuzushiji recognition service. Please acknowledge that this service is built on services made available under the CC BY 4.0 license.",
...
const en: Record<keyof typeof ja, string> = {
  ...
  errorHonkokuUnavailable: "Honkoku v18 is disabled or its model manifest is not configured.",
